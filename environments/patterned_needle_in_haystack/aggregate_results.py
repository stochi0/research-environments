#!/usr/bin/env python3
"""
Aggregate ablation results for Patterned Needle in Haystack experiments.
...
def results_to_dataframe(results: list[dict]) -> pd.DataFrame:
    ...
    for r in results:
        ...
        row = {
            ...
            # Sub-LLM metrics (not expected for non-RLM; defaults to 0)
...
def main():
    parser = argparse.ArgumentParser(description="Aggregate patterned-needle-in-haystack ablation results")
    parser.add_argument(
        "--outputs-dir",
        type=Path,
